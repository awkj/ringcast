...
// reader's own running KiKi as a genuine copy.
import AppKit
...
struct PasteboardTests {
    ...
    static func everyFileFlavourIsRead() {
        withScratch { dir in
            let file = dir.appendingPathComponent("KiKi-Settings-2026-08-20.json")
            ...
            text.setString("KiKi-Settings-2026-08-20.json", forType: .string)
            expect(
