...
struct UninstallTests {
    ...
    static let ownBundleID = "io.github.awkj.kiki"
    static let ownBundleURL = URL(fileURLWithPath: "/Applications/KiKi.app")
    ...
    static func testIdentityRefusal() {
        let byID = UninstallTarget(
            ...
            bundleID: "io.github.awkj.kiki", displayName: "KiKi", bundleName: nil)
        expect(
            UninstallIdentity.make(
                target: byID, otherAppNames: [], ownBundleID: ownBundleID,
                ownBundleURL: ownBundleURL) == nil,
            "KiKi refuses to plan its own uninstall by bundle ID")

        let dev = UninstallTarget(
            bundleURL: URL(fileURLWithPath: "/Applications/KiKi Dev.app"),
            bundleID: "io.github.awkj.kiki.dev", displayName: "KiKi Dev", bundleName: nil)
        expect(
            UninstallIdentity.make(
                target: dev, otherAppNames: [], ownBundleID: "io.github.awkj.kiki.dev",
                ownBundleURL: URL(fileURLWithPath: "/Applications/KiKi Dev.app")) == nil,
