...
struct ExtensionScreen: Equatable {
    enum Kind: Equatable {
        ...
        case detail
        case form
        /// A root component the app doesn't render (`MenuBarExtra`), or nothing rendered yet.
...
struct ExtensionAction: Equatable, Identifiable {
    ...
    var id: Int { node.id }
    var title: String { node.string("title") ?? String(localized: "Action", bundle: .appLanguage) }
