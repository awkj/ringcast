...
to re-register from
and to prune bindings whose record was deleted while RingCast wasn't running. That prune is why
...
window — that is un-remapped HID behaviour, not something RingCast can stop.
