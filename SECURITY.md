...
Include your macOS version, the RingCast version and channel, reproduction steps, and the impact.
...
- **Network** — RingCast is offline by default and every networked feature is consent-gated. A path
